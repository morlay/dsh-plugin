...
| `profile/dsh-agent-toolkit/`               | agent 的工具清单与工具说明（族索引的汉化精简、用法分组）+ Agent Teams 可选子出口：preset 引用它，profile 也可直接装配                                                                  | [README](packages/profile/dsh-agent-toolkit/README.md)               |
| **sandbox**（沙箱替换）                    |                                                                                                                                                             |                                                                      |
