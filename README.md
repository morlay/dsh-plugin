...
| **context**（上下文注入）                  |                                                                                                                                                                                   |                                                                      |
| `context/dsh-context/`                     | 注入能力组（一个包六个出口）：通道 `assembler`、工作区指令 `agent-instructions`、skill 目录 `skill-catalog`、引用展开 `reference`、工具用法分组 `tool-guidance`、模式收口 `scope` | [README](packages/context/dsh-context/README.md)                     |
| **client**（浏览器半基础）                 |                                                                                                                                                                                   |                                                                      |
