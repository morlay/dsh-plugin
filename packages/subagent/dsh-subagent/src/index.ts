...
import { snapshotSubagentDescriptor } from '../../../../vendor/deepseek-harness/packages/subagent/subagent/src/descriptor.ts'
...
import { establishCatalogChild, subagentCatalogProjectionDefinition } from '../../../../vendor/deepseek-harness/packages/subagent/subagent/src/catalog.ts'
...
export type { SubagentCatalogEntry } from '../../../../vendor/deepseek-harness/packages/subagent/subagent/src/projection-types.ts'
export { SubagentError } from '../../../../vendor/deepseek-harness/packages/subagent/subagent/src/error.ts'
export { settleRun } from '../../../../vendor/deepseek-harness/packages/subagent/subagent/src/run-settlement.ts'
...
export type { SubagentIdentityProjection, SubagentTimingProjection } from '../../../../vendor/deepseek-harness/packages/subagent/subagent/src/projection-types.ts'
