...
import type { ActivationTerminal } from '../../../../vendor/deepseek-harness/packages/subagent/subagent/src/lifecycle.ts'
import type { SubagentResult } from '../../../../vendor/deepseek-harness/packages/subagent/subagent/src/types.ts'
